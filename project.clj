(defproject sinewave "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "sinewave.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main sinewave.server
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "sinewave.core/on-figwheel-reload"}

                :compiler {:main sinewave.core
